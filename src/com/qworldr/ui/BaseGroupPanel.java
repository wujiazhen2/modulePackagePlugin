...
public abstract class BaseGroupPanel extends JPanel {
    ...
    private String inputItemName(String initValue) {
        return Messages.showInputDialog("module template name", "module template name", Messages.getQuestionIcon(), initValue, new InputValidator() {
            @Override
    ...
    private DefaultActionGroup createActionGroup() {
        ...
        actionGroup.add(new AnAction(AllIcons.General.Remove) {
            ...
            public void actionPerformed(AnActionEvent e) {
                String groupName = (String) comboBox.getSelectedItem();
                // 确认删除？
                if (MessageDialogBuilder.yesNo("module template info", String.format("确认删除%s？", groupName)).isYes()) {
            ...
            public void update(AnActionEvent e) {
                e.getPresentation().setEnabled(!Objects.equals(comboBox.getSelectedItem(),""));
            }
        });
